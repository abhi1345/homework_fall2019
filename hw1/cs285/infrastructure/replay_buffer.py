...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        randomizedIndices = np.random.permutation(np.arange(self.obs.shape[0]))
        return self.obs[randomizedIndices][-batch_size:], \
                self.acs[randomizedIndices][-batch_size:], \
                self.rews[randomizedIndices][-batch_size:], \
                self.next_obs[randomizedIndices][-batch_size:], \
                self.terminals[randomizedIndices][-batch_size:]
