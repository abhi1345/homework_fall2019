...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            index1, index2 = i*num_data_per_ens, (i+1)*(num_data_per_ens)
            observations = ob_no[index1 : index2] # TODO(Q1)
            actions = ac_na[index1 : index2] # TODO(Q1)
            next_observations = next_ob_no[index1 : index2] # TODO(Q1)
